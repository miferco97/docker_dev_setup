...
$SUDO_PREAMBLE mkdir $HOME/.config -p
$SUDO_PREAMBLE mkdir $HOME/.local/share -p

$SUDO_PREAMBLE apt-get install cppcheck -y $FORCE_PIP
$SUDO_PREAMBLE pip install --user $FORCE_PIP cmakelint 
$SUDO_PREAMBLE pip install --user $FORCE_PIP cpplint
